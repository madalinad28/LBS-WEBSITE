...
However, the challenge I want you to work on is to reproduce two graphs:
...
As the data under investigation follows a normal distribution, we shoudl use the mean to calculate the expected values. The median would be more applicable if we were working with a skewed distribution, as this would distort the mean.